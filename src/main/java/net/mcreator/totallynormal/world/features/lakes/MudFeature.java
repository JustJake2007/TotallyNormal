...
package net.mcreator.totallynormal.world.features.lakes;
...
public class MudFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("totallynormal:mud", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(TotallynormalModBlocks.MUD.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("totallynormal:mud", CONFIGURED_FEATURE,
