...
public class DirtCowEntity extends PathfinderMob {
	public DirtCowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TotallynormalModEntities.DIRT_COW.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new RemoveBlockGoal(Blocks.GRASS_BLOCK, this, 1, (int) 3));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.COARSE_DIRT));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.rooted_dirt.step"));
	}
