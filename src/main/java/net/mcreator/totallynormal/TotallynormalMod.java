 ...
 *
 */
package net.mcreator.totallynormal;
...
import net.mcreator.totallynormal.init.TotallynormalModFeatures;
...
import net.mcreator.totallynormal.init.TotallynormalModBiomes;
...
@Mod("totallynormal")
public class TotallynormalMod {
	public static final Logger LOGGER = LogManager.getLogger(TotallynormalMod.class);
	public static final String MODID = "totallynormal";
